...
export const hyperspeedPresets = {
  ...
  cyberGold: {
    ...
    lightStickWidth: [0.12, 0.5],
    lightStickHeight: [1.3, 1.7],
    movingAwaySpeed: [60, 85],
    movingCloserSpeed: [-120, -165],
    carLightsLength: [400 * 0.04, 400 * 0.2],
    ...
    colors: {
      ...
      islandColor: 0x0a0a0a,
      background: 0x000000,
      shoulderLines: 0x221a0f,
      brokenLines: 0x221a0f,
      leftCars: [0xf0ad4e, 0xffaa00, 0xff7700],
      rightCars: [0x00d2ff, 0x3a7bd5, 0x00f2fe],
      sticks: 0xf0ad4e
    }
  }
};
...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS, lightMode = false }) => {
  ...
  useEffect(() => {
    ...
    const options = {
      ...
      colors: {
        ...
        ...(effectOptions && effectOptions.colors ? effectOptions.colors : {}),
        ...(lightMode
          ? {
              roadColor: 0xffffff,
  ...
  return (
    <div
      className="hyperspeed-canvas-wrapper w-full h-full"
